...
5. Разработка должна быть с использованием базовых технологий (html, js, css)
...
4. Валидация: убедитесь, что пользователь вводит только корректные значения в текстовые поля.
